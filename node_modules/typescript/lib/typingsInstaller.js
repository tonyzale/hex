        ...
        (function (typingsInstaller) {
            ...
            var TypingsInstaller = (function () {
                ...
                TypingsInstaller.prototype.install = function (req) {
                    ...
                    var discoverTypingsResult = ts.JsTyping.discoverTypings(this.installTypingHost, req.fileNames, req.projectRootPath, this.safeListPath, this.packageNameToTypingLocation, req.typingOptions);
                    if (this.log.isEnabled()) {
        ...
        (function (typingsInstaller) {
            ...
            var NodeTypingsInstaller = (function (_super) {
                ...
                function NodeTypingsInstaller(globalTypingsCacheLocation, throttleLimit, log) {
                    var _this = _super.call(this, globalTypingsCacheLocation, ts.toPath("typingSafeList.json", __dirname, ts.createGetCanonicalFileName(ts.sys.useCaseSensitiveFileNames)), throttleLimit, log) || this;
                    _this.installTypingHost = ts.sys;
                    if (_this.log.isEnabled()) {
                        _this.log.writeLine("Process id: " + process.pid);
                    }
                    _this.npmPath = getNPMLocation(process.argv[0]);
                    _this.exec = require("child_process").exec;
                    _this.httpGet = require("http").get;
                    return _this;
                }
